        ...
        <div className="p-4 border-t border-[#2d194a]/60 bg-black/10">
          ...
          {showDownloadBtn && (
            <a
              href="/NaviGuard.apk"
              download
              className="flex items-center justify-center gap-2 w-full px-4 py-2.5 mb-2.5 rounded-xl text-[10px] font-bold uppercase tracking-wider text-purple-200 border border-[#2d194a] bg-black/10 hover:bg-black/25 transition-all duration-300 no-underline text-center cursor-pointer"
            >
              📥 Download Mobile App
            </a>
          )}
          ...
          <div className="flex items-center gap-2.5">
            {showDownloadBtn && (
              <a
                href="/NaviGuard.apk"
                download
                className="flex items-center justify-center w-8 h-8 rounded-full bg-white/10 hover:bg-white/20 text-white border border-white/10 transition-all cursor-pointer text-xs leading-none shadow-sm"
                title="Download App"
              >
                📥
              </a>
